      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-left md:text-center"> {/* Responsive alignment */}
          ...
          duration: 0.8
            ...
            <span className="text-sm text-[#c5b8ff] uppercase">"Where Trusted Brands meet Verified Creators"</span>
          </motion.div>
          ...
          delay: 0.2
            ...
            ABCD
            <span className="block text-accent-purple">All Brands X Creator Deal</span>
          </motion.h1>
        ...
        >INFLUENCIFY is not just about brand deals — it’s the complete ECOSYSTEM that transforms a beginner into a verified, professional, and influential creator.</motion.p>
          ...
          >
            <Button onClick={handleCTAClick} size="lg" className="bg-accent-purple hover:bg-accent-purple/90 text-white font-bold px-8 py-6 text-lg rounded-full group">
              Let's Talk
              <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button onClick={handleViewWorkClick} size="lg" variant="outline" className="border-2 border-accent-purple/40 hover:bg-accent-purple/10 text-white px-8 py-6 text-lg rounded-full">
              View Our Work
            </Button>
          </motion.div>
        </div>
