  ...
  return <section id="cta" className="relative py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">Let's collaborate to bridge the gap between brands and creators. create something extraordinary. Not just followers
“real reach that brands trust & drives results"</p>
          <div>
