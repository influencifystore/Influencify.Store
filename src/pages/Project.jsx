        ...
        <SectionAnimator>
            <div className="container mx-auto px-6 mb-16">
                 <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl shadow-accent-purple/10">
                    <img class="w-full h-full object-cover" alt={project.images.hero.alt} src="https://horizons-cdn.hostinger.com/77e6c737-0d8c-42cb-9119-d1bb13457c16/chatgpt-image-jan-24-2026-08_47_07-pm-i8HKi.png" />
                 </div>
            </div>
        </SectionAnimator>
                ...
                <div className="grid grid-cols-1 gap-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="aspect-square rounded-2xl overflow-hidden">
                           <img class="w-full h-full object-cover" alt={project.images.gallery[1].alt} src="https://horizons-cdn.hostinger.com/77e6c737-0d8c-42cb-9119-d1bb13457c16/download-18-jwiHU.jfif" />
                        </div>
                        <div className="aspect-square rounded-2xl overflow-hidden">
                            <img class="w-full h-full object-cover" alt={project.images.gallery[2].alt} src="https://horizons-cdn.hostinger.com/77e6c737-0d8c-42cb-9119-d1bb13457c16/gemini_generated_image_mxgp1bmxgp1bmxgp-1-RqwfI.png" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <SectionAnimator>
            <div className="container mx-auto px-6 mb-16">
                <div className="aspect-video rounded-2xl overflow-hidden">
                    <img class="w-full h-full object-cover" alt={project.images.gallery2[0].alt} src="https://horizons-cdn.hostinger.com/77e6c737-0d8c-42cb-9119-d1bb13457c16/instagram-live-hujmO.png" />
                </div>
            </div>
        </SectionAnimator>
